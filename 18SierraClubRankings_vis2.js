...
d3.csv("https://alejandro-gallardo.github.io/hostedfiles/2018CoolSchools_SierraClub.csv", function(csvData) {
    ...
    //code below allows vis to resize dynamically with window size
    ...
    svg = d3.select("div#container")
	  ...
	  .attr("viewBox", "0 0 1550 1000")
	  .classed("svg-content", true);

	  //code commented out below creates static graphic that resize dynamically with window size
 ...
 //        .attr('height', h);
    ...
    svg.append('text')
     ...
     svg.append('text')
      ...
      .attr("y", 20)
      .attr('font-weight', 'bold')
      .text('2018 Sierra Club Sustainability Rankings for Higher Ed');
	    ...
	    var yAxis = d3.svg.axis()
	     ...
	     // i call y axis function   
	      ...
	      yLabel = svg.append('text')
			...
			svg.append("rect")
				.datum([room4Improvement[attribute],xcoord,axisGroup])
                .attr('x',xCoord-12.5)
	...
	{
		// console.log(d);
		d3.selectAll('.n'+d.Institution_Name.replace(" ",""))
	...
	function mouseoverRect(d)
	{
    	...
    	svg.append('text')
	          ...
	          .attr("x", d[1]+15)
	          .attr("y", (d[2])/3*h +40)
	          .text('points available in cateogry for Carleton!');
	    svg.append('text')
	          .attr('class','popup')
